...
int main() {
    ...
    std::complex<double> z1 = {0. + 0i}, z2 = {1. + 1i}, z3 = {2. + 2i}, z4 = {0. +0i};
    complexList.add(z1); complexList.add(z2); complexList.add(z3); complexList.add(z4);
    ...
    std::string s1 = "abc", s2 = "def", s3 = "ghi",s4 ="abc";

    stringList.add(s1); stringList.add(s2); stringList.add(s3); stringList.add(s4);
